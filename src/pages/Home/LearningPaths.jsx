    ...
    <div className="max-w-6xl mx-auto px-4 py-12 text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white shadow-lg rounded-2xl p-5 hover:shadow-xl transition-all duration-300">
          <h3 className="text-xl font-semibold mb-2 text-indigo-600">Web Development</h3>
        ...
        {/* Card 3 */}
        <div className="bg-white shadow-lg rounded-2xl p-5 hover:shadow-xl transition-all duration-300">
          <h3 className="text-xl font-semibold mb-2 text-indigo-600">Mobile App Development</h3>
          <p className="text-gray-600 text-sm">
